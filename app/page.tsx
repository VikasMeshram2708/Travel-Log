  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 sm:py-16">
        {/* Hero Section */}
        <div className="border border-border bg-card/80 backdrop-blur-sm shadow-lg flex flex-col space-y-6 items-center h-[32rem] justify-center p-8 rounded-xl text-center">
          <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full mb-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground max-w-2xl leading-tight">
