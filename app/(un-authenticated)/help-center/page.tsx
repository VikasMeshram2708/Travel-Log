          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                document, organize, and relive your travel experiences — all in
                one place.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                Yes, you’ll need to create a free account to start logging your
                journeys and syncing them across devices.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-3">
              <AccordionTrigger>Can I use Travel Log offline?</AccordionTrigger>
              <AccordionContent>
                At the moment, Travel Log requires an internet connection. We’re
                actively working on adding offline support in future releases.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                We use industry-standard encryption to protect your data, and we
                never sell your personal information. Your memories are yours —
                always.
              </AccordionContent>
            </AccordionItem>
