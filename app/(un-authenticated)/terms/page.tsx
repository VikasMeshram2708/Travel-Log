        ...
        <Card>
          <CardContent className="prose prose-neutral dark:prose-invert max-w-none p-6">
            ...
            <p>
              ...
              content, you grant Travel Log a non-exclusive license to display
              and store your content solely for the purpose of providing our
              services.
            </p>
            ...
            <h2>7. Disclaimer</h2>
            <p>
              Travel Log is provided “as is” without warranties of any kind. We
              do not guarantee uninterrupted service or the accuracy of content
              created by users.
            </p>
