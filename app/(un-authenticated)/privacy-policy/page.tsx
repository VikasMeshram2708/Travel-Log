    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <Card className="p-6 md:p-8">
        <section className="mb-10">
          <p className="mb-6">
            At <strong>TravelPass</strong>, we prioritize your privacy and data
            security. This Privacy Policy explains how we collect, use,
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <li>
              <strong>Travel Preferences</strong> - Destinations, trip history,
              saved places
            </li>
            <li>
          ...
          <h3 className="font-medium mb-2">C. Automatically Collected Data</h3>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Communicate with you about updates and offers (opt-out available)
            </li>
